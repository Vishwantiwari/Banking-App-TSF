...
import static com.example.banking_app.R.layout.activity_userdata;
...
public class user_data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(com.example.banking_app.user_data.this);
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new DatabaseUserNames(this).readparticulardata(phonenumber);
    ...
    private void enterAmount() {
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(com.example.banking_app.user_data.this);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mAmount.getText().toString().isEmpty()){
                    ...
                    Intent intent = new Intent(com.example.banking_app.user_data.this, Transcation.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(com.example.banking_app.user_data.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseUserNames(com.example.banking_app.user_data.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
                        Toast.makeText(com.example.banking_app.user_data.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
