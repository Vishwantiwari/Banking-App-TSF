...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.example.banking_app.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.example.banking_app.ViewHolder.ClickListener clickListener){
