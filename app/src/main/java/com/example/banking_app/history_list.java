...
public class history_list extends AppCompatActivity {
    ...
    private void showData() {
        ...
        Cursor cursor = new DatabaseUserNames(this).readtransferdata();
        ...
        adapter = new CustomeAdapter_history(com.example.banking_app.history_list.this, modelList_historylist);
