...
public class Transcation extends AppCompatActivity {
    ...
    com.example.banking_app.CustomeAdapter_sendtouser adapter;
    ...
    private void showData(String phonenumber) {
        ...
        Log.d(TAG, "showData: ");
        Cursor cursor = new DatabaseUserNames(this).readselectuserdata(phonenumber);
        ...
        adapter = new com.example.banking_app.CustomeAdapter_sendtouser(Transcation.this, modelList_sendtouser);
        mRecyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
        selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        Cursor cursor = new DatabaseUserNames(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new DatabaseUserNames(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new DatabaseUserNames(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
            Toast.makeText(this, "Transaction Successful!", Toast.LENGTH_LONG).show();
            startActivity(new Intent(Transcation.this, com.example.banking_app.user_list.class));
            finish();
        }
    }
    ...
    private void calculateAmount() {
        ...
        new DatabaseUserNames(this).updateAmount(phonenumber, remainingamount);
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Transcation.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseUserNames(Transcation.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(Transcation.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(Transcation.this, com.example.banking_app.user_list.class));
                        finish();
                    }
